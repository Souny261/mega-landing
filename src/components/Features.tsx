  ...
  return <section id="features" className="w-full py-12 md:py-24 lg:py-32 bg-muted">
    <div className="container px-4 md:px-6">
      ...
      <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 mt-16">
        ...
        <div className="animated-feature-card col-span-1 md:col-span-2 lg:col-span-1 flex flex-col items-center justify-center gap-2 rounded-lg border bg-primary p-6 shadow-sm">
          <h3 className="text-lg font-bold text-primary-foreground">
            Ready to optimize your inventory?
          </h3>
          <button className="animated-button inline-flex h-10 items-center justify-center rounded-md bg-primary-foreground px-8 text-sm font-medium text-primary shadow transition-colors hover:bg-primary-foreground/90">
            Start Free Trial
          </button>
        </div>
      </div>
